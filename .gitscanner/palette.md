...
- [2026-09-02] Dynamically styling widgets (like the status bar) by adding/removing CSS classes via `widget.add_class` / `widget.remove_class` provides better TUI visual feedback.
