...
- **Quiet Flag**: Added `--quiet` (`-q`) flag to the CLI to suppress all rich UI elements and output only raw directory paths. This is designed for script piping (e.g., to xargs).
