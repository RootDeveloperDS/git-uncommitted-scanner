...
- **Export to CSV**: Added support for exporting scan results to CSV format. The CLI now dynamically infers the export format (JSON or CSV) based on the specified file extension.
