...
- Added `--quiet` (`-q`) flag to CLI. This allows suppressing all Rich UI elements, spinners, and tables to output raw directory paths, which is very useful for shell scripting and piping to tools like `xargs`.
