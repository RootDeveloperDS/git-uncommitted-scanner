...
## Last Commit Age Upgrade
- **Upgrade**: Added "Last Commit Age" display to the CLI and TUI output, and included it in the JSON export.
- **Practical Value**: Helps developers prioritize which uncommitted repositories to deal with based on how old the last commit is.
