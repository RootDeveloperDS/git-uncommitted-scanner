...
- [Optimization] Moved `textual` imports and `GitScannerTUI` class inside a lazy execution function to improve CLI startup latency (measured drop from ~0.65s to ~0.16s).
