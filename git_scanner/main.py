...
# TUI IMPLEMENTATION
# ---------------------------------------------------------
def run_tui_app(target_dir: Path, exclude: Optional[List[str]] = None, max_depth: Optional[int] = None) -> None:
    ...
    tui_app = GitScannerTUI(target_dir, exclude=exclude, max_depth=max_depth)
    tui_app.run()
