...
def scan(
    ...
    quiet: bool = typer.Option(False, "--quiet", "-q", help="Suppress output and only print raw directory paths for script piping")
):
    ...
    if quiet:
        ...
        ctx = console.status(f"[bold cyan]Scanning {base_path}...[/bold cyan]", spinner="dots")
