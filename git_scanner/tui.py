...
from .main import find_git_repos, get_repo_details, truncate_path, open_external_terminal
...
def run_tui_app(target_dir: Path, exclude: Optional[List[str]] = None, max_depth: Optional[int] = None):
    app = GitScannerTUI(target_dir, exclude=exclude, max_depth=max_depth)
    app.run()
